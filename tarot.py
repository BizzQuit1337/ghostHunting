...
class Card:
    ...
    def draw(self, surface, width, height):
        ...
        if not self.flipped:
            pygame.draw.rect(surface, (0, 0, 0), (self.x, self.y, width, height))
        else:
...
cards = [Card(f"Card {i + 1}") for i in range(10)]
...
running = True
card_index = 0
target_positions = [(100, (width - card_width) // 2), (300, (width - card_width) // 2), (500, (width - card_width) // 2)]
